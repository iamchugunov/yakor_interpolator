...
>>>>>>> Stashed changes
                ...
                Vr_meas_tr, theta_meas_tr = func_quad_piece_app(config.loc_X, config.loc_Y, config.loc_Z,
                                                                ...
                                                                config.SKO_theta, [config.k0, config.v0, config.dR,
                                                                                   config.angle_bounds[0]],
                                                                t_meas,
                                                                R_meas_filter, Vr_meas_filter, theta_meas_filter,
                                                                winlen,
                                                                step_sld, parameters_bounds, types=0, window=1)
                ...
                V_abs_true_start, alpha_true_start, A_abs_true_start, Ax_true_start, Ah_true_start = func_quad_piece_estimation_start(
                    x_est_app_start, t_meas, meas_t_ind, window_set, config.m, g, config.loc_X, config.loc_Y,
                    config.loc_Z, N)

                # предыдущие х и у
                xhy_0_set_1, x_est_fin_1, meas_t_ind, window_set, t_meas_tr, R_meas_tr, \
                Vr_meas_tr, theta_meas_tr = func_quad_piece_app(config.loc_X, config.loc_Y, config.loc_Z,
                                                                config.can_Y,
                                                                config.m, g, config.SKO_R, config.SKO_Vr,
                                                                config.SKO_theta,
                                                                x_est_app_start, t_meas,
                                                                R_meas_filter, Vr_meas_filter, theta_meas_filter,
                                                                winlen,
<<<<<<< Updated upstream
                                                                step_sld, parameters_bounds)
=======
                                                                step_sld, parameters_bounds, types=0, window=0)
                print(x_est_fin, 'fin')
>>>>>>> Stashed changes
...
=======
                    x_est_app_start, t_meas, config.m, g, config.loc_X, config.loc_Y, config.loc_Z, N)
>>>>>>> Stashed changes
