    ...
    if config.ini_data_flag:
        ...
        if config.bullet_type == 1 or config.bullet_type == 2:  # 5.45 bullet or 7.65 bullet
            ...
            try:
                ...
                z_wind = func_wind(t_fin[-1], x_true_fin[-1], x_est_start, config.wind_module,
        ...
        if config.bullet_type == 3:  # 82 mina
            ...
            try:
                ...
                # сравнение x_est_start и x_est_app_start
                ...
                R_est_err, Vr_est_err, theta_est_err, t_err_plot = func_linear_piece_estimation_error(
                    xhy_0_set, x_est_fin, x_true_start, h_true_start, x_true_fin, h_true_fin,
                    window_set, t_meas,
                    R_meas_filter,
                    Vr_meas_filter,
