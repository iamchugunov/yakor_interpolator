...
from function import kalman_filter_xV, kalman_filter_theta, func_linear_piece_app, func_linear_piece_estimation, \
    ...
    func_trajectory_end, func_filter_data, func_active_reactive
...
if bullet_type == 6:
    ...
    R_meas_1, Vr_meas_1, theta_meas_1 = func_filter_data(t_meas_1, R_meas_1, Vr_meas_1, theta_meas_1, ksi_Vr, n1, n2, ksi_theta,
                                                   theta_n1)
    ...
    R_meas_2, Vr_meas_2, theta_meas_2 = func_filter_data(t_meas_2, R_meas_2, Vr_meas_2, theta_meas_2, ksi_Vr, n1, n2, ksi_theta,
                                                   theta_n1)


    winlen = 30; step_sld = 10;

    parameters_bounds_1 = [[0.004, 0.005], [350, 635], [-65, 65], [np.deg2rad(25), np.deg2rad(50)]]

    parameters_bounds_2 = [[0.001, 0.004], [200, 420], [-65, 65], [np.deg2rad(-10), np.deg2rad(35)]]
